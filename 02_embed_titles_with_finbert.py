# 02_embed_titles_with_finbert.py

"""
Encode news headlines using FinBERT from HuggingFace and attach them to the volatility-labeled data.
Saves a new CSV file with 768-dim FinBERT embeddings + volatility target.
"""
